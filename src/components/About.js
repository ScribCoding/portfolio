const About = ({reference}) =>{
    return(
        ...
        <svg className="name-text-container">
            <text className="main-text" textAnchor="middle" x="50%" y="50%" fill="#000000" stroke="#000000" strokeWidth="2">
        ...
        <svg className="im-text-container">
            <text className="sub-text" x="" y="50%" fill="#fff" stroke="#000000" strokeWidth="2" >
